...
![Microsoft Entra sign-in event anatomy showing identity, authentication, device and location, application and resource, Conditional Access and risk, outcome, and correlation identifiers.](../../assets/images/articles/entra-sign-in-logs/entra-sign-in-event-anatomy.png)
...
![Microsoft Entra sign-in investigation example showing Status, Authentication Details, Device Information, Conditional Access, and Location combining to identify an unmet device compliance requirement.](../../assets/images/articles/entra-sign-in-logs/entra-sign-in-investigation-fields.png)
...
![Microsoft Entra sign-in log fields reference map grouping identity, authentication, device and location context, resource, access decision, outcome, and correlation fields.](../../assets/images/articles/entra-sign-in-logs/entra-sign-in-fields-reference-map.png)
...
**Why Is Conditional Access Blocking My User? A Systematic Troubleshooting Method**

That article explains **how to investigate a failed access decision**. This guide explains **how to interpret the evidence inside the sign-in event**.
