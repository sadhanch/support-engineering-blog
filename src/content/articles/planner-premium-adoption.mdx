...
![Planner Premium role-based adoption model showing different responsibilities and focus areas for project managers, contributors, stakeholders, PMOs, and administrators.](../../assets/images/articles/planner-premium-adoption/planner-premium-role-based-adoption.png)
...
![Planner Premium adoption model showing the four stages Assess, Pilot, Govern, and Scale as a progression from understanding the current environment to expanding a tested operating model.](../../assets/images/articles/planner-premium-adoption/planner-premium-adoption-model.png)
