...
![Comparison of Basic Planner and Premium Planner architectures, showing Basic plans managed through the Planner service and Premium projects backed by Dataverse with structured project data, security, and broader platform integration.](../../assets/images/articles/planner-premium-integrations/planner-basic-vs-premium-architecture.png)
...
![Planner Premium Dataverse ecosystem showing Premium project data centered in Dataverse and connected to Power Automate, Power Apps, Power BI, Microsoft services, security, relationships, and APIs.](../../assets/images/articles/planner-premium-integrations/planner-premium-dataverse-ecosystem.png)
...
![Planner Power Automate connector boundary showing the native Planner connector supporting Basic plans while Premium projects use a Dataverse-backed architecture and require a different integration approach.](../../assets/images/articles/planner-premium-integrations/planner-power-automate-connector-boundary.png)
