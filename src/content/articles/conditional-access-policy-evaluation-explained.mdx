...
import conditionalAccessPolicyEvaluationModel from "../../assets/images/articles/conditional-access-policy-evaluation/conditional-access-policy-evaluation-model.png";
import conditionalAccessMultiplePolicyEvaluation from "../../assets/images/articles/conditional-access-policy-evaluation/conditional-access-multiple-policy-evaluation.png";
import conditionalAccessEvaluationVsOutcome from "../../assets/images/articles/conditional-access-policy-evaluation/conditional-access-evaluation-vs-outcome.png";
...
<ArticleImageLightbox
  src={conditionalAccessPolicyEvaluationModel.src}
  alt="Diagram showing the Microsoft Entra Conditional Access policy evaluation model from sign-in context and policy assignments through conditions, applicable policies, grant, block and session controls to the final access outcome."
/>
...
<ArticleImageLightbox
  src={conditionalAccessMultiplePolicyEvaluation.src}
  alt="Diagram showing one Microsoft Entra sign-in evaluated against multiple Conditional Access policies, where MFA succeeds, a compliant-device requirement fails, and the combined evaluation results in access being denied."
/>
...
<ArticleImageLightbox
  src={conditionalAccessEvaluationVsOutcome.src}
  alt="Diagram distinguishing Conditional Access policy evaluation from session controls, showing that access can be granted while session controls can still restrict the user's experience."
/>
...
<ul>❌ Exclude the user</ul>
<ul>❌ Disable the policy</ul>
<ul>❌ Remove MFA</ul>
<ul>❌ Change the device requirement</ul>
