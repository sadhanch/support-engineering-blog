...
import plannerPremiumDataverseReferenceArchitecture from "../../assets/images/articles/planner-premium-and-dataverse/01_planner_premium_dataverse_reference_architecture.png";
import plannerPremiumIntegrationSurface from "../../assets/images/articles/planner-premium-and-dataverse/02_planner_premium_integration_surface.png";
import plannerPremiumDataLifecycle from "../../assets/images/articles/planner-premium-and-dataverse/03_planner_premium_data_lifecycle.png";
...
<ArticleImageLightbox
  src={plannerPremiumDataverseReferenceArchitecture.src}
  alt="Reference architecture showing Planner Premium using Dataverse as its project data platform, with Power Automate, Power BI, Power Apps, APIs, and enterprise systems connected around the project workload."
/>
...
<ArticleImageLightbox
  src={plannerPremiumIntegrationSurface.src}
  alt="Planner Premium at the center of an integration surface connected to Power Automate automation, Power BI reporting, custom applications and APIs, and Microsoft 365 collaboration and data services."
/>
...
<ArticleImageLightbox
  src={plannerPremiumDataLifecycle.src}
  alt="Planner Premium project data lifecycle from creation and Dataverse storage through use, integration, reporting, project closure, and final retention, archival, or deletion."
/>
