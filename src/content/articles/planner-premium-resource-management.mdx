...
![Planner Premium resource visibility within a single Premium project, showing People view for workload distribution and Assignments view for task-level effort and assignment details.](../../assets/images/articles/planner-premium-resource-management/planner-premium-resource-visibility.png)
...
![Planner Premium project data flowing through Dataverse into Power BI for a consolidated, read-only cross-project resource analysis, while project assignments remain managed in Planner.](../../assets/images/articles/planner-premium-resource-management/planner-premium-cross-project-boundary.png)
