...
import onePremiumProjectDifferentLicensingNeeds from "../../assets/images/articles/planner-premium-licensing/01_one_premium_project_different_licensing_needs.png";
import plannerLicensingLayers from "../../assets/images/articles/planner-premium-licensing/02_planner_licensing_layers.png";
...
<ArticleImageLightbox
  src={onePremiumProjectDifferentLicensingNeeds.src}
  alt="A single Planner Premium project connecting five roles—Project Manager, Project Lead, Contributor, Stakeholder, and PMO Representative—showing that each role can have different responsibilities and licensing requirements."
/>
...
flowchart TD
    ...
    subgraph P["ONE PREMIUM PROJECT"]
        A["Project Manager"]
        B["Contributors"]
        C["Stakeholders"]

        D["Premium capability access"]
        E["Basic participation"]
        F["Visibility / reporting"]
...
**Request → Evaluate → Assign → Use → Review → Continue or Reclaim**
...
**Assess → Classify → Request → Validate → Trial → License → Adopt → Review → Reclaim**

<PlannerPremiumLicenseFitCheck />

<ArticleImageLightbox
  src={plannerLicensingLayers.src}
  alt="Three-layer Planner licensing model showing how plan type, user subscription, and available capabilities combine to determine what a user can access and manage."
/>
