...
![Conditional Access troubleshooting methodology showing the sequence Symptom, Evidence, Policy, Evaluation, Root Cause, and Remediation.](../../assets/images/articles/conditional-access-troubleshooting/conditional-access-troubleshooting-method.png)
...
![Conditional Access policy evaluation showing multiple policies applying to one sign-in, with one failed requirement causing an overall Access Denied result.](../../assets/images/articles/conditional-access-troubleshooting/conditional-access-policy-evaluation.png)
...
![Conditional Access root-cause map showing device, network and location, authentication strength and context, grant controls, session controls, and client or application requirements as the main areas to investigate when a sign-in is blocked or an action is restricted.](../../assets/images/articles/conditional-access-troubleshooting/conditional-access-root-cause-map.png)
...
Check Device info
        ↓
Check compliance / join state
        ↓
Identify unmet requirement
```
...
![Conditional Access investigation tools comparison showing Report-only for policy testing, What If for policy-scope simulation, and Sign-in Logs and Diagnostics for investigating what actually happened.](../../assets/images/articles/conditional-access-troubleshooting/conditional-access-investigation-tools.png)
...
1. Capture the symptom
          ↓
2. Find the exact sign-in
          ↓
3. Review authentication and device details
          ↓
4. Review Conditional Access
          ↓
5. Identify the unmet requirement
          ↓
6. Classify the root cause
          ↓
7. Apply the narrowest remediation
          ↓
8. Retest
          ↓
